        ...
        <body>
            ...
            <h:form>
                <h:panelGrid columns="2">
                    ...
                    <h:panelGroup>
                        ...
                        <h:panelGroup rendered="#{event.event.calendar != null}">
                            ...
                            <h:commandLink value="Show" action="#{calendar.detailSetup}">
                                ...
                                <f:param name="jsfcrud.currentCalendar" value="#{jsfcrud_class['jsf.classes.controller.bean.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][event.event.calendar][calendar.converter].jsfcrud_invoke}"/>
                                <f:param name="jsfcrud.relatedController" value="event"/>
                                <f:param name="jsfcrud.relatedControllerType" value="jsf.classes.controller.bean.EventController"/>
                            </h:commandLink>
                            <h:outputText value=" "/>
                    ...
                    <h:panelGroup>
                        <h:outputText value="#{event.event.weather}"/>
                        <h:panelGroup rendered="#{event.event.weather != null}">
                            <h:outputText value=" ("/>
                            <h:commandLink value="Show" action="#{weather.detailSetup}">
                                <f:param name="jsfcrud.currentEvent" value="#{jsfcrud_class['jsf.classes.controller.bean.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][event.event][event.converter].jsfcrud_invoke}"/>
                                <f:param name="jsfcrud.currentWeather" value="#{jsfcrud_class['jsf.classes.controller.bean.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][event.event.weather][weather.converter].jsfcrud_invoke}"/>
                                <f:param name="jsfcrud.relatedController" value="event"/>
                                <f:param name="jsfcrud.relatedControllerType" value="jsf.classes.controller.bean.EventController"/>
                            </h:commandLink>
                            <h:outputText value=" "/>
