/*
 * Entity class of the Participant
 */
package jsf.entity;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Participant.findAcceptedEventByUser", query = "SELECT p.event1 FROM Participant p WHERE p.participant = 'YES' AND p.participantPK.user = :user"),
    @NamedQuery(name = "Participant.findByUserEvent", query = "SELECT p FROM Participant p WHERE p.participantPK.user = :user AND p.participantPK.event = :event"),
...
public class Participant implements Serializable {
    ...
    public String toString() {
        return "jsf.entity.Participant[ participantPK=" + participantPK + " ]";
    }
